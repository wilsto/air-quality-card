...
`;class cardContent{static generateTitle(e){const s=e.title!==void 0?ot` <h1 class="pool-monitor-title">${e.title}</h1> `:ot``;return ot`${s}`}static generateBody(e,s){if(!s)return ot` <div class="warning-message">No sensor data available</div> `;return ot`
    ...
    `}static _moreinfo(e){const s=new Event("hass-more-info",{bubbles:true,composed:true});s.detail={entityId:e};const o=document.querySelector("home-assistant");if(o)o.dispatchEvent(s)}}const Pt={compact:false,show_names:true,show_labels:true,show_last_updated:false,show_icons:true,show_units:true,gradient:true,language:"en"};const Tt={low:"#fdcb6e",warn:"#e17055",normal:"#00b894",cool:"#00BFFF",marker:"#000000",hi_low:"#00000099"};function getDisplayConfig(){return Object.assign({},Pt)}function getColorConfig(){return Object.assign({},Tt)}function getSensorConfig(e,s){if(!s[e])return{};return Object.assign({},s[e])}class MonitorCardBase extends i{render(){const e=this.getConfig();const s=this.processData();const o=e.display.compact?cardContent.generateCompactBody:cardContent.generateBody;if(!s||Object.keys(s).length===0)return ot` <div id="pool-monitor-card">
      ...
      ${Object.values(s).map(s=>{if(s===null||s===void 0?void 0:s.invalid)return ot`
          ...
          `;return o(e,s)})}
    </div>`}processData(){const e={};const s=this.getConfig();Object.entries(s.sensors).forEach(([s,o])=>{const r=Array.isArray(o)?o:[o];r.forEach((o,r)=>{const l=`${s}_${r+1}`;e[l]=this.calculateData(s,o.title||this.getTranslatedText("sensor."+s),o.entity,o.min,o.max,o.setpoint,o.step,o.unit,o.icon,o.image_url,o.mode,o.min_limit,o.override_value,o.override,o.invalid)})});return e}getTranslatedText(e,s){var o;const r=((o=this.config)===null||o===void 0?void 0:o.display.language)||"en";const l=getTranslation(r,e);return formatTranslation(l,s)}calculateData(e,s,o,r,l,u,p,h,m,g,_,v,f,$,b){var w,A,C,E,P,T;const O={};const j=this.getConfig();const U=this.constructor.SENSORS||{};const F=getSensorConfig(e,U);const B=this.constructor.IMAGE_BASE_URL||"";O.name=e;O.invalid=b;O.mode=_;O.title=j.display.show_names?s:ot`&nbsp;`;O.hide_icon=false;O.is_mdi=false;if(!j.display.show_icons)O.hide_icon=true;else{const s=m||"";const o=g||"";if(s==="hide")O.hide_icon=true;else if(o)O.img_src=o;else if(s&&typeof s==="string"&&s.startsWith("mdi:")){O.is_mdi=true;O.mdi_icon=s}else if(B)O.img_src=`${B}/${e}.png`;else{O.is_mdi=true;O.mdi_icon="mdi:gauge"}}if(!this.hass||!this.hass.states||!this.hass.states[o]){console.warn(`Entity not found: ${o}`);O.value=null;O.entity=o;return O}const q=this.hass.states[o];const W=(w=this.hass.entities)===null||w===void 0?void 0:w[o];const G=(T=(E=(A=W===null||W===void 0?void 0:W.display_precision)!==null&&A!==void 0?A:(C=q.attributes)===null||C===void 0?void 0:C.display_precision)!==null&&E!==void 0?E:(P=q.attributes)===null||P===void 0?void 0:P.precision)!==null&&T!==void 0?T:this.countDecimals(parseFloat(q.state));const Q=parseFloat(q.state);O.value=isNaN(Q)?null:Number(Q.toFixed(G));O.entity=o;if(j.display.show_last_updated)O.last_updated=this.timeFromNow(q.last_updated);O.unit=j.display.show_units?h||F.unit||"":"";if($)O.value=f||F.override;O.min_value=r!==void 0&&this.hass.states[r]&&!isNaN(parseFloat(this.hass.states[r].state))?parseFloat(this.hass.states[r].state):O.value;O.max_value=l!==void 0&&this.hass.states[l]&&!isNaN(parseFloat(this.hass.states[l].state))?parseFloat(this.hass.states[l].state):O.value;const K=u!=null?parseFloat(String(u)):F.setpoint!=null?parseFloat(String(F.setpoint)):O.value;const Y=p!=null?parseFloat(String(p)):F.step!=null?parseFloat(String(F.step)):.1;const J=Math.max(this.countDecimals(K),this.countDecimals(Y));O.setpoint=K;const X=v!==void 0?Number(v):-1/0;const tt=Math.max(X,K-2*Y);const et=Math.max(X,K-Y);const it=Math.max(X,K);const st=Math.max(X,K+Y);const rt=Math.max(X,K+2*Y);O.setpoint_class=[tt.toFixed(J),et.toFixed(J),it.toFixed(J),st.toFixed(J),rt.toFixed(J)];O.separator=j.display.show_labels?"-":"";O.color="transparent";if(O.value!==null)O.value=Math.max(X,O.value);if(_==="heatflow")if(Number(O.value)<Number(O.setpoint_class[1])){O.state=j.display.show_labels?this.getTranslatedText("state.1"):"";O.color=j.colors.cool}else if(Number(O.value)>=Number(O.setpoint_class[1])&&Number(O.value)<Number(O.setpoint_class[3])){O.state=j.display.show_labels?this.getTranslatedText("state.3"):"";O.color=j.colors.low}else{O.state=j.display.show_labels?this.getTranslatedText("state.5"):"";O.color=j.colors.warn}else if(Number(O.value)<Number(O.setpoint_class[0])){O.state=j.display.show_labels?this.getTranslatedText("state.1"):"";O.color=j.colors.warn}else if(Number(O.value)>=Number(O.setpoint_class[0])&&Number(O.value)<Number(O.setpoint_class[1])){O.state=j.display.show_labels?this.getTranslatedText("state.2"):"";O.color=j.colors.low}else if(Number(O.value)>=Number(O.setpoint_class[1])&&Number(O.value)<Number(O.setpoint_class[2])){O.state=j.display.show_labels?this.getTranslatedText("state.3"):"";O.color=j.colors.normal}else if(Number(O.value)>=Number(O.setpoint_class[2])&&Number(O.value)<Number(O.setpoint_class[3])){O.state=j.display.show_labels?this.getTranslatedText("state.4"):"";O.color=j.colors.normal}else if(Number(O.value)>=Number(O.setpoint_class[3])&&Number(O.value)<Number(O.setpoint_class[4])){O.state=j.display.show_labels?this.getTranslatedText("state.5"):"";O.color=j.colors.low}else if(Number(O.value)>=Number(O.setpoint_class[4])){O.state=j.display.show_labels?this.getTranslatedText("state.6"):"";O.color=j.colors.warn}O.progressClass=e==="temperature"?"progress-temp":"progress";O.pct=Math.max(0,Math.min(98.5,Math.max(0,O.value-(K-3*Y))/(6*Y)*.85*100+15)).toFixed(0);O.pct_min=Math.max(0,Math.min(98.5,Math.max(0,O.min_value-(K-3*Y))/(6*Y)*.85*100+15)).toFixed(0);O.pct_max=Math.max(0,Math.min(98.5,Math.max(0,O.max_value-(K-3*Y))/(6*Y)*.85*100+15)).toFixed(0);O.pct_marker=O.value>O.setpoint?O.pct-12:O.pct-5;O.side_align=O.value>K?"right":"left";O.pct_cursor=O.value>K?100-parseFloat(O.pct):parseFloat(O.pct)-2;O.pct_state_step=O.value>K?105-parseFloat(O.pct):parseFloat(O.pct)+5;O.pct_min=O.value>K?100-parseFloat(O.pct_min):parseFloat(O.pct_min)-2;O.pct_max=O.value>K?100-parseFloat(O.pct_max):parseFloat(O.pct_max)-2;return O}countDecimals(e){if(e===void 0||e===null)return 0;if(Math.floor(e)===e)return 0;const s=e.toString();if(s.includes("."))return s.split(".")[1].length||0;return 0}timeFromNow(e){const s=new Date(e);const o=Date.now()-s.getTime();const t=(e,s)=>{const o=s===1?"time":"time_plural";const r={[e]:s};return this.getTranslatedText(`${o}.${e}`,r)};const r=Math.floor(o/6e4);const l=Math.floor(r/60);const u=Math.floor(l/24);if(r<1)return t("seconds",0);if(r<60)return t("minutes",r);if(l<24)return t("hours",l);return t("days",u)}getConfig(){return this.config}setConfig(e){const s=this.constructor.SENSORS||{};const o=Object.keys(s);const r={display:getDisplayConfig(),colors:getColorConfig()};const l=Object.assign(Object.assign({},e),{display:Object.assign(Object.assign({},r.display),e.display||{}),colors:Object.assign(Object.assign({},r.colors),e.colors||{}),sensors:{}});if(!e.sensors)throw new Error('Configuration requires sensors to be defined under the "sensors" key.');Object.entries(e.sensors).forEach(([e,r])=>{const u=s[e]||{};const p=Array.isArray(r)?[...r]:[Object.assign({},r)];if(p.length===0)throw new Error(`Empty sensor array for ${e}`);const h=p.map(e=>Object.assign(Object.assign(Object.assign({},u),e),{nameDefinedByUser:!!e.name}));h.forEach((s,r)=>{if(!s.entity)throw new Error(`Missing entity for ${e}[${r}]`);if(s.nameDefinedByUser)s.title=s.name;if(o.length>0&&!o.includes(e))s.invalid=true;else s.invalid=false});l.sensors[e]=h});this.config=l}}MonitorCardBase.SENSORS={};MonitorCardBase.IMAGE_BASE_URL="";MonitorCardBase.styles=Et;__decorate([n$1({attribute:false})],MonitorCardBase.prototype,"hass",void 0);__decorate([n$1({attribute:false})],MonitorCardBase.prototype,"config",void 0);const Mt={temperature:{name:"Temperature",unit:"°C",setpoint:21,step:1,mode:"heatflow"},humidity:{name:"Humidity",unit:"%",setpoint:45,step:5,mode:"centric",min_limit:0},co2:{name:"CO2",unit:"ppm",setpoint:800,step:200,mode:"centric",min_limit:0},pm25:{name:"PM2.5",unit:"µg/m³",setpoint:12,step:6,mode:"centric",min_limit:0},pm10:{name:"PM10",unit:"µg/m³",setpoint:25,step:12,mode:"centric",min_limit:0},voc:{name:"VOC",unit:"ppb",setpoint:250,step:100,mode:"centric",min_limit:0},tvoc:{name:"TVOC",unit:"µg/m³",setpoint:300,step:100,mode:"centric",min_limit:0},formaldehyde:{name:"Formaldehyde",unit:"µg/m³",setpoint:30,step:15,mode:"centric",min_limit:0},radon:{name:"Radon",unit:"Bq/m³",setpoint:100,step:50,mode:"centric",min_limit:0},aqi:{name:"Air Quality Index",unit:"AQI",setpoint:50,step:25,mode:"centric",min_limit:0},pressure:{name:"Atmospheric Pressure",unit:"hPa",setpoint:1013,step:10,mode:"centric"},noise:{name:"Noise Level",unit:"dB",setpoint:40,step:10,mode:"centric",min_limit:0}};const Ot="0.2.0";const Nt="2026-02-23-16-04";const zt=`${Ot} (${Nt})`;console.info(`%c AIR-QUALITY-CARD %c ${zt} `,"color: white; background: #00b894; font-weight: 700;","color: #00b894; background: white; font-weight: 700;");e.AirQualityCard=class AirQualityCard extends MonitorCardBase{};e.AirQualityCard.CARD_INFO={cardType:"air-quality-card",cardName:"Air Quality Card",cardDescription:"A Home Assistant card for monitoring indoor and outdoor air quality (CO2, PM2.5, VOC, humidity, etc.)"};e.AirQualityCard.SENSORS=Mt;e.AirQualityCard.IMAGE_BASE_URL="https://raw.githubusercontent.com/wilsto/air-quality-card/master/resources";e.AirQualityCard=__decorate([t$2("air-quality-card")],e.AirQualityCard);Object.defineProperty(e,Symbol.toStringTag,{value:"Module"});return e}({});

...
`;const Te=.1;const Ne=3;const je={direction:null,count:0};function computeTrend(e,s){if(e==null||!Number.isFinite(e))return je;const o=s!=null&&Number.isFinite(s)&&s>0?s:Te;const l=Math.floor(Math.abs(e)/o);if(l<1)return je;return{direction:e>0?"rising":"falling",count:Math.min(Ne,l)}}function trendGlyphs(e){if(!e||!e.direction||e.count<1)return"";return(e.direction==="rising"?"▴":"▾").repeat(e.count)}function trendLabelKey(e){if(!e||!e.direction||e.count<1)return null;return`trend.${e.direction}_${Math.min(Ne,e.count)}`}function hasScale(e,...s){if(Array.isArray(e)&&e.length===4&&e.every(e=>Number.isFinite(Number(e))))return true;return s.some(e=>e!=null&&e!==""&&Number.isFinite(Number(e)))}function outOfScale(e,s,o){const l=typeof e==="number"?e:Number(e);if(e==null||e===""||!Number.isFinite(l))return null;if(!Number.isFinite(s)||!Number.isFinite(o)||o<=s)return null;if(l<s)return"below";if(l>o)return"above";return null}function overflowGlyph(e){if(e==="above")return"▸";if(e==="below")return"◂";return""}function overflowLabelKey(e){return e?`out_of_scale.${e}`:null}const labelShift=e=>{if(e<=.5)return"translateX(0)";if(e>=99.5)return"translateX(-100%)";return"translateX(-50%)"};const markerShift=e=>{const s=Math.max(0,Math.min(100,e));const o=Number(s.toFixed(2));const l=Number((100-s).toFixed(2));return`translateX(clamp(${-o}cqw, -50%, calc(${l}cqw - 100%)))`};class cardContent{static generateTitle(e){const s=e.title!==void 0?ae` <h1 class="pool-monitor-title">${e.title}</h1> `:ae``;return ae`${s}`}static generateStatusBadge(e,s){return ae`
    ...
    `}static generateTrend(e){const s=trendGlyphs(e.trend);if(!s)return"";return ae`<span class="trend-arrow" aria-hidden="true">${s}</span
      ...
      ><span class="sr-only">${e.out_of_scale_label||""}</span>`}static generateBody(e,s){if(!s)return ae` <div class="warning-message">No sensor data available</div> `;const o=s.pct_marker;const l=markerShift(o);const u=o<=1?"translateX(0)":o>=99?"translateX(-100%)":"translateX(-50%)";return ae`
      <!-- ##### ${s.name} section ##### -->
      <div
    ...
    `}static generateCompactBody(e,s){if(!s)return ae` <div class="warning-message">No sensor data available</div> `;return ae`
      <!-- ##### ${s.name} section ##### -->
        ...
        ${Object.values(s).map(s=>{if(s===null||s===void 0?void 0:s.invalid)return ae`
            ...
            `;else if(s===null||s===void 0?void 0:s.no_scale)return ae`
              <div class="warning-message">
                <ha-icon icon="mdi:alert"></ha-icon>
                <span
                  >Sensor ${(s===null||s===void 0?void 0:s.name)||"unknown"} has no scale, so no reading can be judged
...
`;const editorText=(e,s)=>getTranslation((e===null||e===void 0?void 0:e.language)||"en",`editor.${s}`);class MonitorEditorBase extends i{t(e){return editorText(this.hass,e)}setConfig(e){this._config=Object.assign(Object.assign({},e),{display:Object.assign(Object.assign({},Fe),e.display),colors:Object.assign(Object.assign({},ze),e.colors),sensors:e.sensors||{}})}render(){if(!this.hass||!this._config)return ae``;return ae`
    ...
    `}_renderSensorType(e,s){if(Array.isArray(s))return ae`${s.map((o,l)=>this._renderSensorRow(e,o,l,s.length>1))}`;return this._renderSensorRow(e,s,0,false)}_renderSensorRow(e,s,o,l){const u=l?`${e}-${o}`:e;const p=this._expanded[u]||false;const h=this.registry[e];const m=(h===null||h===void 0?void 0:h.name)||e;const g=l?`${m} #${o+1}`:m;return ae`
